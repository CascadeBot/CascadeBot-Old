...
public enum ModlogEvent {
    ...
    GUILD_MEMBER_ROLE_REMOVED(Category.GUILD, Category.GUILD_MEMBER),
    GUILD_MEMBER_NICKNAME_UPDATED(Category.GUILD, Category.GUILD_MEMBER),

    GUILD_USER_BANNED(Category.GUILD, Category.GUILD_MEMBER, Category.MODERATION),
    ...
    GUILD_MESSAGE_DELETED_SELF(Category.GUILD, Category.GUILD_MESSAGE),
