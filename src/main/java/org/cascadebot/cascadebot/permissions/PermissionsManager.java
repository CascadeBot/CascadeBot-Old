...
public class PermissionsManager {
    ...
    public void registerPermissions() {
        ...
        registerPermission(CascadePermission.of("Force voice channel join", "join.force", false, Permission.VOICE_MOVE_OTHERS));
        registerPermission(CascadePermission.of("Force voice channel leave", "leave.force", false, Permission.VOICE_MOVE_OTHERS));
