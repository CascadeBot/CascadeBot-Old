...
package org.cascadebot.cascade.messaging;
...
public class MessagingTyped {
     ...
     * When embeds for the guild are on, it replies with an embed with the embed color being the color defined in {@link MessageType#INFO}
     * If embeds are turned off, it replies with a normal message with the Unicode character defined in {@link MessageType#INFO} in the title and the embed formatted using {@link org.cascadebot.cascade.utils.FormatUtils#formatEmbed(MessageEmbed)}
     *
     ...
     * When embeds for the guild are on, it replies with an embed with the embed color being the color defined in {@link MessageType#WARNING}
     * If embeds are turned off, it replies with a normal message with the Unicode character defined in {@link MessageType#WARNING} in the title and the embed formatted using {@link org.cascadebot.cascade.utils.FormatUtils#formatEmbed(MessageEmbed)}
     *
     * @param builder The embed builder to use as the message.
     */
     ...
     * When embeds for the guild are on, it replies with an embed with the embed color being the color defined in {@link MessageType#MODERATION}
     * If embeds are turned off, it replies with a normal message with the Unicode character defined in {@link MessageType#MODERATION} in the title and the embed formatted using {@link org.cascadebot.cascade.utils.FormatUtils#formatEmbed(MessageEmbed)}
     *
     * @param builder The embed builder to use as the message.
     */
     ...
     * When embeds for the guild are on, it replies with an embed with the embed color being the color defined in {@link MessageType#DANGER}
     * If embeds are turned off, it replies with a normal message with the Unicode character defined in {@link MessageType#DANGER} in the title and the embed formatted using {@link org.cascadebot.cascade.utils.FormatUtils#formatEmbed(MessageEmbed)}
     *
     * @param builder The embed builder to use as the message.
     */
