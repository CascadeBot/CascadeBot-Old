...
import org.cascadebot.cascade.data.objects.Setting;
import org.cascadebot.cascade.data.objects.SettingsContainer;
...
public class SettingsCommand implements ICommandMain {
    ...
    public void onCommand(Member sender, CommandContext context) {
        ...
        try {
            ReflectionUtils.getClasses("org.cascadebot.cascade.data.objects")
                           .stream()
