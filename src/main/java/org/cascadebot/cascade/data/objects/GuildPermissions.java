...
import org.cascadebot.cascade.permissions.objects.Group;
import org.cascadebot.cascade.permissions.objects.PermissionAction;
import org.cascadebot.cascade.permissions.objects.Result;
import org.cascadebot.cascade.permissions.objects.User;
    ...
    public Group createGroup(String name) {
        ...
        do {
            ...
            if (++iterations == 7) {
                ...
                Cascade.LOGGER.error("Somehow we couldn't manage to create a unique group ID :(");
