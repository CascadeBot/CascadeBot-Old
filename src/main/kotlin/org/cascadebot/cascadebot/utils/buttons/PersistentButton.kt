...
enum class PersistentButton(@field:Transient val button: Button) {
    ...
    TODO_BUTTON_NAVIGATE_LEFT(
        Button.UnicodeButton(
            UnicodeConstants.BACKWARD_ARROW,
            IButtonRunnable { runner: Member, channel: TextChannel, message: Message ->
                val todoList =
    ...
    TODO_BUTTON_NAVIGATE_RIGHT(
        Button.UnicodeButton(
            UnicodeConstants.FORWARD_ARROW,
            IButtonRunnable { runner: Member, channel: TextChannel, message: Message ->
                val todoList =
                    GuildDataManager.getGuildData(channel.guild.idLong).useful.getTodoListByMessage(message.idLong)
                if (!todoList.canUserEdit(runner.idLong)) {
    ...
    VOTE_BUTTON_YES(
        Button.UnicodeButton(
            ...
            IButtonRunnable { runner: Member, channel: TextChannel, message: Message ->
                val voteButtonGroup =
                    GuildDataManager.getGuildData(channel.guild.idLong).persistentButtons[channel.idLong]!![message.idLong] as VoteButtonGroup?
